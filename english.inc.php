...
$_lang['OrderType']['dedicated'] = 'Dedicated server';
...
$_lang['ProfileOrgComment'] = 'Full name of your company typed in Russian as written in your registration documents.<BR>Example: Limited Lability Company `Horns and Hooves`';
$_lang['ProfilePassportData'] = 'Passport info';
$_lang['ProfilePassportSeriya'] = 'Series and number';
$_lang['ProfilePassportSeriyaComment'] = 'Do not put the NUMBER symbol before the number.<BR>Example, Russia: 34 02 651241; Example, Ukraine: HC 223344';
$_lang['ProfilePassportVidan'] = 'Issued by';
$_lang['ProfilePassportVidanComment'] = 'Fully title of the state body issuing the passport.<BR>Example: Police station #48 in Moscow';
$_lang['ProfilePassportVidanData'] = 'Date of issue';
$_lang['ProfileBirthDate'] = 'Date of birth';
$_lang['ProfileInn'] = 'TIN';
$_lang['ProfileInnComment'] = 'Tax identification number (TIN).<BR>Example: 789012345678';
$_lang['ProfileOrgEng'] = 'Company (eng.)';
$_lang['ProfileOrgEngComment'] = 'Full name of your company in Latin characters.<BR>Example: `ROGA I KOPYTA`, LTD.';
$_lang['ProfileYuridAddress'] = 'Legal address';
$_lang['ProfileYuridAddressComment'] = 'Legal address of your company as stated in your registration documents.<BR>Example: 101000, Moscow, Poupkine str. 1, building. 2';
$_lang['ProfileInnComment2'] = 'Tax payer number (TIN) of your company.<BR>Example: 7701107259';
...
$_lang['ProfileKppComment'] = 'Company registration code (KPP).  Mandatory for Russian companies.<BR>Example: 632946014';
