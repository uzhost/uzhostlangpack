...
$_lang['ErrorAPIcode22'] = 'Допустимый срок регистрации доменного имени, лет';
...
$_lang['ErrorAPIcode35'] = 'Допустимый срок продления доменного имени, лет';
...
$_lang['OrdersChangeSlots'] = 'Изменить кол-во слотов';
...
$_lang['ProfileMobileOperatorCode'] = 'Мобильный телефон (код оператора)';
...
$_lang['OrderSSLCSRWarning'] = 'Если у Вас не сохранился Private Key для указанного CSR, обязательно сгенерируйте новый CSR код!';

$_lang['OrderErrorAllowOnlyOneOrderByOneUser'] = 'Тарифный план можно заказать только один раз.';
$_lang['ErrorAPIHcode27'] = 'Тарифный план можно заказать только один раз';

$_lang['ProfilePersonalNumber'] = 'Personal ID';

$_lang['DomainsReqTransferAuth'] = 'Получить код трансфера';
$_lang['DomainsReqTransferAuthAlert'] = 'Код трансфера будет отправлен на Ваш email. Вы уверены, что хотите получить новый код трансфера?';
$_lang['DomainsUpdateAuthCodeSuccess'] = 'Новый код трансфера успешно отправлен на Ваш email.';
$_lang['DomainsUpdateAuthCodeSendSuccess'] = 'Запрос на изменение кода трансфера успешно отправлен администрации и будет выполнен в ближайшее время.';

$_lang['ErrorWrongCaptcha2'] = 'Подтвердите, что Вы не робот.';

$_lang['SettingsEdocsEmail'] = 'Email для электронных документов';
$_lang['ProfileErrorBadEdocsEmail'] = 'Указан неправильный Email для электронных документов.';

$_lang['regFields']['regPurpose'] = 'Цель регистрации';

$_lang['ButtonResendEmailCode'] = 'Отправить повторно';

#####################################################################################
##################### v2.2.2
#####################################################################################

$_lang['OrdersReset'] = 'Сбросить / Reset';
$_lang['OrdersResetAlert'] = 'Вы уверены, что хотите сбросить сервер? Это принудительно остановит его без корректного завершения работы операционной системы, что может привести к потере информации!';
$_lang['OrdersResetSuccess'] = 'Сброс успешно запущен.';
$_lang['OrdersResetError'] = 'Не удалось выполнить сброс. Ожидайте пока это сделает администрация.';
$_lang['OrdersErrorCantReset'] = 'Вы не можете выполнить сброс для данного заказа.';
$_lang['OrdersServerInfoServerIPv6'] = 'IPv6 адрес сервера';
$_lang['SokraschenieTB'] = 'ТБ';
$_lang['TrafficOut'] = 'Трафик';
$_lang['OrdersVncTitle'] = "VNC-консоль";
$_lang['OrdersVncLink'] = "VNC-консоль";
$_lang['OrdersGotoVncError'] = "Не удалось получить данные для подключения к VNC.";

$_lang['PayPayer'] = 'Плательщик';

$_lang['ErrorAPIcode62'] = 'Не указаны дополнительные поля';
